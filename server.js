...
const io = new Server(server, {
    cors: {
        origin: ["http://vietstallminh.site.je", "https://vietstallminh.site.je"], // Khi deploy thực tế, hãy thay "*" bằng URL web InfinityFree của bạn để bảo mật (VD: "http://moji.infinityfreeapp.com")
        methods: ["GET", "POST"]
    }
});
